...
from core.SelfMTG6D.datasets.dataset_factory import register_datasets_in_cfg
from core.SelfMTG6D.engine.self_engine_utils import get_DIBR_models_renderer, get_dibr_models_renderer
from core.SelfMTG6D.engine.self_engine import do_test, do_train, do_save_results

from core.SelfMTG6D.models import MTGOPE, MTGOPE_double_mask  # noqa
from core.SelfMTG6D.models import DeepIM_FlowNet  # noqa
...
def main(args):
    ...
    logger.info(f"Used MTGOPE module name: {cfg.MODEL.POSE_NET.NAME}")
