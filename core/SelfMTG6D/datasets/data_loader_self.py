...
class MTGOPE_Self_DatasetFromList(Base_DatasetFromList):
...
def build_MTGOPE_self_train_loader(cfg, dataset_names, train_objs=None):
    ...
    dataset = MTGOPE_Self_DatasetFromList(cfg, split="train", lst=final_dataset_dicts, copy=False, flatten=True)
