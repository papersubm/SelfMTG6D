...
SPLITS_HB = dict(
    hb_val_primesense_bop19=dict(
        ...
        ann_file=osp.join(DATASETS_ROOT, "BOP_DATASETS/hb/hb_val_targets_bop19.json"),
    ...
    hb_val_primesense_all=dict(
        ...
        ann_file=osp.join(DATASETS_ROOT, "BOP_DATASETS/hb/hb_val_targets_all.json"),
        scale_to_meter=0.001,
        with_masks=True,  # (load masks but may not use it)
        with_depth=True,  # (load depth path here, but may not use it)
        height=480,
...
if __name__ == "__main__":
    ...
    Usage:
        python -m core.MTGOPE_modeling.datasets.hb_bop_val dataset_name
    """
