...
if __name__ == "__main__":
    ...
    new_res_path = osp.join(
        ...
        "resnest50d_AugCosyAAEGray_BG05_visib10_mlBCE_DoubleMask_ycbvPbr100e_SO_ycbv_test_MTGOPEPose_with_yolov4_pbr_bbox.json",
    )
    if osp.exists(new_res_path):
        wprint("{} already exists! overriding!".format(new_res_path))

    out_root = "output/MTGOPE/ycbvPbrSO/resnest50d_AugCosyAAEGray_BG05_visib10_mlBCE_DoubleMask_ycbvPbr100e_SO/"
    pred_paths = [
        "01_02MasterChefCan/inference_model_final_wo_optim-8624c7f1/ycbv_test/results.pkl",
        "02_03CrackerBox/inference_model_final_wo_optim-72f9c1da/ycbv_test/results.pkl",
        "03_04SugarBox/inference_model_final_wo_optim-bf2dc932/ycbv_test/results.pkl",
        "04_05TomatoSoupCan/inference_model_final_wo_optim-b142bb56/ycbv_test/results.pkl",
        "05_06MustardBottle/inference_model_final_wo_optim-86dde7e2/ycbv_test/results.pkl",
        "06_07TunaFishCan/inference_model_final_wo_optim-0b376921/ycbv_test/results.pkl",
        "07_08PuddingBox/inference_model_final_wo_optim-23fb01c0/ycbv_test/results.pkl",
        "08_09GelatinBox/inference_model_final_wo_optim-1256bdbd/ycbv_test/results.pkl",
        "09_10PottedMeatCan/inference_model_final_wo_optim-cc1232e2/ycbv_test/results.pkl",
        "10_11Banana/inference_model_final_wo_optim-427d6321/ycbv_test/results.pkl",
        "11_19PitcherBase/inference_model_final_wo_optim-f052dafc/ycbv_test/results.pkl",
        "12_21BleachCleanser/inference_model_final_wo_optim-59a61f06/ycbv_test/results.pkl",
        "13_24Bowl/inference_model_final_wo_optim-55b952fc/ycbv_test/results.pkl",
        "14_25Mug/inference_model_final_wo_optim-6b280ec5/ycbv_test/results.pkl",
        "15_35PowerDrill/inference_model_final_wo_optim-0769bee7/ycbv_test/results.pkl",
        "16_36WoodBlock/inference_model_final_wo_optim-baaa72c3/ycbv_test/results.pkl",
        "17_37Scissors/inference_model_final_wo_optim-eb042de2/ycbv_test/results.pkl",
        "18_40LargeMarker/inference_model_final_wo_optim-3c805088/ycbv_test/results.pkl",
        "19_51LargeClamp/inference_model_final_wo_optim-9643daa1/ycbv_test/results.pkl",
        "20_52ExtraLargeClamp/inference_model_final_wo_optim-82f2dafa/ycbv_test/results.pkl",
        "21_61FoamBrick/inference_model_final_wo_optim-375a4cba/ycbv_test/results.pkl",
    ]
