...
from .data_loader_online import MTGOPE_Online_DatasetFromList
...
def build_MTGOPE_augmentation(cfg, is_train):
...
class MTGOPE_DatasetFromList(Base_DatasetFromList):
    ...
    def __init__(self, cfg, split, lst: list, copy: bool = True, serialize: bool = True, flatten=True):
        ...
        """
        self.augmentation = build_MTGOPE_augmentation(cfg, is_train=(split == "train"))
...
def build_MTGOPE_train_loader(cfg, dataset_names):
    ...
    if cfg.MODEL.POSE_NET.XYZ_ONLINE:
        dataset = MTGOPE_Online_DatasetFromList(cfg, split="train", lst=dataset_dicts, copy=False)
    else:
        dataset = MTGOPE_DatasetFromList(cfg, split="train", lst=dataset_dicts, copy=False)
...
def build_MTGOPE_test_loader(cfg, dataset_name, train_objs=None):
    ...
    dataset = MTGOPE_DatasetFromList(cfg, split="test", lst=dataset_dicts, flatten=False)
