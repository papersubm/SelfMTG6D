...
if __name__ == "__main__":
    ...
    --result_dir output/MTGOPE/lmoPbrSO/r34OnlineAugCosyAAEGray_lmoPbr100e_SO/ \
    --result_names r34OnlineAugCosyAAEGray-lmoPbr100e-merged-bop-test-test-iter0_lmo-test.csv \
    --dataset lmo \
    --split test \
    --split-type "" \
