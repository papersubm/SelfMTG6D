_base_ = ["../../../_base_/SelfMTG6D_base.py"]

# refiner_cfg_path = "configs/_base_/SelfMTG6D_refiner_base.py"

OUTPUT_DIR = "output/SelfMTG6D/ssLMCrop/FreezeBN_20e_Blender08_bboxCrop_woDepth_refinePM100_blenderCrop_DZI10/ape"
INPUT = dict(
    WITH_DEPTH=True,
    DZI_PAD_SCALE=1.0,
    TRUNCATE_FG=False,
...
DATASETS = dict(
    TRAIN=("lm_crop_ape_train",),  # real data
    TRAIN2=("lm_blender_ape_train",),  # synthetic data
    TRAIN2_RATIO=0.8,
    TEST=("lm_crop_ape_test",),
    # for self-supervised training
    DET_FILES_TRAIN=(
        "datasets/BOP_DATASETS/lm/test/init_poses/resnest50d_a6_AugCosyAAEGray_BG05_mlBCE_bboxCrop_DZI10_lm_blender_100e_so_MTGOPEPose_wBboxCrop_wDeepimPose_lmCropTrain.json",
    ),
    DET_THR_TRAIN=0.5,
)
...
MODEL = dict(
    ...
    WEIGHTS="output/MTGOPE/lm_crop_blender/resnest50d_a6_AugCosyAAEGray_BG05_mlBCE_bboxCrop_DZI10_lm_blender_100e/ape/model_final_wo_optim-ab325295.pth",
    REFINER_WEIGHTS="",
    FREEZE_BN=True,
    ...
    LOAD_DETS_TEST=False,  # directly use bbox_crop
    BBOX_CROP_REAL=True,
    BBOX_CROP_SYN=True,
    EMA=dict(
        ENABLED=True,
    ...
    POSE_NET=dict(
        NAME="MTGOPE",  # used module file name
