...
# ape
./core/SelfMTG6D/test_SelfMTG6D.sh \
...
#python core/SelfMTG6D/engine/test_utils.py \
#    --result_dir output/SelfMTG6D/ssLMO/ss_mlBCE_MaskFull_PredFull_lr1e_5_lower_woCenter_refinePM10_lmoNoBopTest/merged-bop-test/ \
