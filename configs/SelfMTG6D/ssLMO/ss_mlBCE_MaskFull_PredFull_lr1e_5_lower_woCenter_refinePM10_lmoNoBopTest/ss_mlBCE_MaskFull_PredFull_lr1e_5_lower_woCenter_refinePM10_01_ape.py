...
OUTPUT_DIR = "output/SelfMTG6D/ssLMO/ss_mlBCE_MaskFull_PredFull_lr1e_5_lower_woCenter_refinePM10_lmoNoBopTest/ape"
INPUT = dict(
    WITH_DEPTH=True,
    DZI_PAD_SCALE=1.5,
    TRUNCATE_FG=False,
...
MODEL = dict(
    ...
    WEIGHTS="output/MTGOPE/lmoPbrSO/resnest50d_online_AugCosyAAEGray_mlBCE_DoubleMask_lmo_pbr_100e/ape/model_final_wo_optim-f0ef90df.pth",
    REFINER_WEIGHTS="",
    FREEZE_BN=True,
