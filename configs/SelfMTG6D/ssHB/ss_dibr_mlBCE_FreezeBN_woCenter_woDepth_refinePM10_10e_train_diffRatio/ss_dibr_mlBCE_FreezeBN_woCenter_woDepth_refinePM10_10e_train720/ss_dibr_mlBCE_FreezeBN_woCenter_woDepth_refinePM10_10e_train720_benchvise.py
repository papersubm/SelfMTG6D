...
OUTPUT_DIR = "output/SelfMTG6D/ssHB/ss_dibr_mlBCE_FreezeBN_woCenter_woDepth_refinePM10_10e_train720/benchvise"
INPUT = dict(
    WITH_DEPTH=True,
    DZI_PAD_SCALE=1.5,
    TRUNCATE_FG=False,
...
DATASETS = dict(
    TRAIN=("hb_bdp_benchvise_train720",),  # real data
    TRAIN2=("lm_pbr_benchvise_train",),  # synthetic data
    TRAIN2_RATIO=0.0,
    TEST=("hb_bdp_benchvise_test100",),
    # for self-supervised training
    DET_FILES_TRAIN=(
        "datasets/hb_bench_driller_phone/init_poses/resnest50d_a6_AugCosyAAEGray_BG05_mlBCE_lm_pbr_100e_so_MTGOPEPose_wYolov4PbrBbox_wDeepimPose_hbBdpAll.json",
    ),
    DET_THR_TRAIN=0.5,
    DET_FILES_TEST=(
...
MODEL = dict(
    ...
    WEIGHTS="output/MTGOPE/lm_pbr/resnest50d_a6_AugCosyAAEGray_BG05_mlBCE_lm_pbr_100e/benchvise/model_final_wo_optim-85b3563e.pth",
    REFINER_WEIGHTS="",
    FREEZE_BN=True,
