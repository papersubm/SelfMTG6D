...
OUTPUT_DIR = "output/SelfMTG6D/ssLM/ss_v1_dibr_mlBCE_FreezeBN_woCenter_woDepth_refinePM10/ape"
INPUT = dict(
    WITH_DEPTH=True,
    DZI_PAD_SCALE=1.5,
    TRUNCATE_FG=False,
...
MODEL = dict(
    ...
    WEIGHTS="output/MTGOPE/lm_pbr/resnest50d_a6_AugCosyAAEGray_BG05_mlBCE_lm_pbr_100e/ape/model_final_wo_optim-e8c99c96.pth",
    # init
    # ad10    rete5    te2
    # 50.86   98.57    91.81
    REFINER_WEIGHTS="",
