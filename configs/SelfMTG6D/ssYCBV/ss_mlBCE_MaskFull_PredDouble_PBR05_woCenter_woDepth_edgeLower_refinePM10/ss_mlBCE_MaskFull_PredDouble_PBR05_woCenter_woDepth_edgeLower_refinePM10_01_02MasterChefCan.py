...
OUTPUT_DIR = (
    "output/SelfMTG6D/ssYCBV/ss_mlBCE_MaskFull_PredDouble_PBR05_woCenter_woDepth_edgeLower_refinePM10/01_02MasterChefCan"
)
...
DATASETS = dict(
    ...
    DET_FILES_TRAIN=(
        "datasets/BOP_DATASETS/ycbv/test/init_poses/resnest50d_AugCosyAAEGray_BG05_visib10_mlBCE_DoubleMask_ycbvPbr100e_SO_MTGOPEPose_wBboxCrop_wCosyPose_ycbvTrainRealUw.json",
    ),
    DET_THR_TRAIN=0.5,
    DET_FILES_TEST=(
...
MODEL = dict(
    ...
    WEIGHTS="output/MTGOPE/ycbvPbrSO/resnest50d_AugCosyAAEGray_BG05_visib10_mlBCE_DoubleMask_ycbvPbr100e_SO/01_02MasterChefCan/model_final_wo_optim-8624c7f1.pth",
    REFINER_WEIGHTS="",
    FREEZE_BN=True,
    ...
    POSE_NET=dict(
        NAME="MTGOPE_double_mask",  # used module file name
