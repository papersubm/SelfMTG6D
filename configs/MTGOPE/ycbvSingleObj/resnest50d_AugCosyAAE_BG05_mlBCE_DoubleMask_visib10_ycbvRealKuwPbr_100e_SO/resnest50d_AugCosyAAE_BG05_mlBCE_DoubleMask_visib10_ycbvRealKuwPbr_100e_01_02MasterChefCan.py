...
OUTPUT_DIR = (
    "output/MTGOPE/ycbv/resnest50d_AugCosyAAE_BG05_mlBCE_DoubleMask_visib10_ycbvRealKuwPbr_100e_SO/01_02MasterChefCan"
)
INPUT = dict(
    DZI_PAD_SCALE=1.5,
    TRUNCATE_FG=False,
...
DATASETS = dict(
    TRAIN=(
        "ycbv_002_master_chef_can_train_real_aligned_Kuw",
        "ycbv_002_master_chef_can_train_pbr",
    ),
    TEST=("ycbv_test",),
    # AP	AP50	AP75	AR	inf.time
    # 71.81 	92.32 	82.24 	81.00 	24.7ms
    DET_FILES_TEST=(
